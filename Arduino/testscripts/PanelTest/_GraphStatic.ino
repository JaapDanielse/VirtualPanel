  ...
  switch (event) 
  {
    ...
    { 
     // initialize panel layout
      ...
      Panel.Send(Slider_1, "trig");
      Panel.Send(Slider_1, trig);
      Panel.Send(MaxSlider_1, 220);
      Panel.Send(Slider_2, F("v-pos"));
      Panel.Send(Slider_2, vpos);
      Panel.Send(MaxSlider_2, 255);
      Panel.Send(Slider_3, F("v/div"));
      Panel.Send(Slider_3, (int)vdiv);
      Panel.Send(MaxSlider_3, 150);
      Panel.Send(Slider_4, F("s/div"));
      Panel.Send(Slider_4, (int)tsincount*10);
