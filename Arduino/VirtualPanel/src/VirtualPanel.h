...
enum vp_channel : uint16_t // event/channel list 
{
  ...
  GraphValueCount_5, // 
  // 
  GraphCaption_1, // >any > caption text
  GraphCaption_2, //
  //
  GraphLabel_1, // >any > label text
  GraphLabel_2, //
  GraphLabel_3, //
  GraphLabel_4, //
  GraphLabel_5, //
  //
  GraphButton_1, // any > button text
  GraphButton_2, //
  GraphButton_3, //
  GraphButton_4, //
  //
  GraphClick, //  < int16_t
  GraphDoubleClick, // < int16_t
  GraphRightClick, // < int16_t
	//
  Info, // >text
  InfoTitle, // >text > Title text, resets InfoText
  InfoText, // >text
  //
  PanelColor, // >text > colorstring
  //
  GraphDrawCircle, // >circle paramsting
  //
  GraphInput_1, // >any
  GraphInput_2, //
  GraphInput_3, //
...
enum vpsrq_Stats : byte
{
  vpsrq_Success,
  vpsrq_Timeout,
  vpsrq_InvalidChannel,
  vpsrq_ConcurrencyErr
};

extern vpsrq_Stats PanelSrqStatus;
