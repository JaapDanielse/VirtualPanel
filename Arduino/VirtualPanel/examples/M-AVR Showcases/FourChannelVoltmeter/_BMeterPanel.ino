...
{ 
  switch (event) 
  {
    ...
    case GraphInput_1: GraphInput(event,CHName[0]); break;
    case GraphInput_2: GraphInput(event,CHName[1]); break;
    case GraphInput_3: GraphInput(event,CHName[2]); break;
    case GraphInput_4: GraphInput(event,CHName[3]); break;
...
//---------------------------------------------------------------
void GraphInput(vp_channel event, char * ChannelName)
{
