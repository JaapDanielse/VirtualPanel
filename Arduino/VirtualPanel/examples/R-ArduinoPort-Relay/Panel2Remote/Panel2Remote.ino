...
enum Soft_Channel : uint8_t// event/channel list for slave Arduino communication
{
  DataRequest,
  SetValue_1,
  SetValue_2,
...
void SoftPortCallback_1 (uint8_t event);
...
void SoftPortCallback_2 (uint8_t event);
...
void sendRemote(uint8_t Channel, int16_t Value)
{
  if(RemoteSelect == 1)
  {
