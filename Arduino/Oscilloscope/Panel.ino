...
{ 
   switch (event) 
  {
    ...
    case ScrollBar_2: { StepSize = Panel.vpr_int+1; DisplayStatic(); break; }
...
void DisplayStatic()
{
  ...
  Panel.Sendf(GraphCaption_2,"%d ms/div - %s V/div", (int)(StepSize * 1.25), outstr);
  Panel.Sendf(Display_2,"%d ms/div", (int)(StepSize * 1.25));
...
void PanelInit()
{
    ...
    Panel.Send(MaxScrollBar_2,79);
    Panel.Send(ScrollBar_2,"time");
    Panel.Send(ScrollBar_2,StepSize);
